...
function addImageBurst(x, y, baseSize = 200) {
	return; // THÊM DÒNG NÀY ĐỂ TRIỆT TIÊU ẢNH KHI PHÁO NỔ
...
function spawnWishMessage() {
	return; // THÊM DÒNG NÀY ĐỂ TẮT CHỮ BAY CŨ
...
function spawnWishImage() {
	return; // THÊM DÒNG NÀY ĐỂ TẮT ẢNH BAY
    const layer = appNodes.wishesLayer;
...
function startWishesLoop() {
	return; // THÊM DÒNG NÀY ĐỂ KHÓA TOÀN BỘ VÒNG LẶP CŨ
